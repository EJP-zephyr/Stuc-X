                ...
                <div className="max-w-fit bg-[#030303] flex items-center justify-center border-[#494949] rounded-lg h-fit border px-4 py-7">
                    <div className="max-w-[90%] max-h-[80%]">
                        ...
                        <form action='#' className="w-full flex flex-col items-center">
                            ...
                            <NavLink to='/chat' className="w-[100%] bg-[#54F8A9] text-center text-black px-3 py-2 rounded-md font-medium">Sign In</NavLink>
                            ...
                            <p className="text-[#f5f9fc] text-xs mt-5 pt-5 w-[100%] text-center border-t border-t-[#494949]">Don't have an account? <NavLink to='/signup' className="text-[#54F8A9]">Sign up</NavLink></p>
                        </form>
                    </div>
                </div>  
            </div>
